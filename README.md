# Cypress development for TELEVES
...
```bash
git clone https://github.com/classroomLabs/televes-cy-dev
cd televes-cy-dev
npm install
# run cypress
npm start
...
## Target project [_Subject Under Test_](https://github.com/AlbertoBasalo/ng-dev)
